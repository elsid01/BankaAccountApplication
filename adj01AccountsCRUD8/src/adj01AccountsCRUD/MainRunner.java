...
//		System.out.println("Good bye");
	...
	private static void deleteAccounts() { // move ????
	...
	private static void updateAccounts() { // move ????
		// 1. verify array is not empty
	...
	private static boolean isArrayEmpty() {   // move
		if (accountArray.last>0) return false;
		return true;
	}

	private static void addAccounts() {  // move ???
		int accountId = 0;
	...
	private static void addAcount(int accountId) { //move
		accountArray.last++;
		accountArray.idArray[accountArray.last] = accountId;
	}

	private static boolean existAccountId(int accountId) { // move
		Arrays.sort(accountArray.idArray);
	...
	private static boolean isAccountArrayFull() { //move
	...
	private static void initAccountArray() { //move
		accountArray.last = -1;
